...
unsigned char g_uclanguage;	//语言编号

const struct str_LANG_PACKAGE *g_pLang;
const char *pFONT56;
const char *pFONT48;
const char *pFONT40;
const char *pFONT32;
...
{    
    assert_param(IS_VALID_LANG(lang));
        
	g_uclanguage = lang;
    if(lang == LANG_CHN){
        g_pLang = &g_LangPack_CHN;
		
		pFONT56 = &GB_56[0].Index[0];
		pFONT48 = &GB_48[0].Index[0];			
		pFONT40 = &GB_40[0].Index[0];	
		pFONT32 = &GB_32[0].Index[0];
		pFONT24 = &GB_24[0].Index[0];			
		pFONT20 = &GB_20[0].Index[0];			
		pFONT16 = &GB_16[0].Index[0];
		pFONT12 = &GB_12[0].Index[0];
			
		pPIC104 =	&W_104[0].Index[0];
    }
    else if(lang == LANG_ENG){
        g_pLang = &g_LangPack_ENG;
    ...
    else if(lang == LANG_KOR){
        g_pLang = &g_LangPack_KOR;
...
const struct str_LANG_PACKAGE g_LangPack_ENG = 
{
    "Start",            //char ui_Start_ID_Start[10];          //ui_Start界面
    "Verify",          //char ui_Start_ID_JianDing[10]; 
    "Browse",       //char ui_Start_ID_Browse[10]; 
    "Setting",        //char ui_Start_ID_Setting[10];
   
    "Measure",      //char ui_Main_ID_Titile[10];          //ui_Main界面  
    "Help",         //char ui_Main_ID_Info[10]; 
};
...
// 字库: 横向取模左高位
// -------------------------------------------------------------- //
const unsigned char nAscii6x8Dot[] =              // ASCII
{
	...
	0x70,0x08,0x08,0x70,0x08,0x08,0x70,0x00, // -3-
	...
	0x00,0x08,0x1C,0x2A,0x2A,0x2A,0x1C,0x08, // -fi-
};
...
// 字库: 横向取模左高位
// -------------------------------------------------------------- //
const unsigned char nAscii8x16Dot[] =              // ASCII
{
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // - -
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
// 字库: 横向取模左高位
// -------------------------------------------------------------- //
const unsigned char nAscii12x24Dot[] =              // ASCII
{
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // - -
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
// 字库: 横向取模左高位    0--9
// -------------------------------------------------------------- //
const unsigned char nAscii20x32Dot[] =              // ASCII
{
//0
0x00,0x00,0x00,0x00,0x00,0x00,0x01,0xF8,0x00,0x07,0xFE,0x00,0x0F,0xFF,0x00,0x1F,
0xFF,0x80,0x1F,0x0F,0x80,0x1F,0x0F,0xC0,0x3E,0x07,0xC0,0x3E,0x07,0xC0,0x3C,0x03,
0xE0,0x7C,0x03,0xE0,0x7C,0x03,0xE0,0x7C,0x03,0xE0,0x7C,0x03,0xE0,0x7C,0x03,0xE0,
0x7C,0x03,0xE0,0x7C,0x03,0xE0,0x7C,0x03,0xE0,0x7C,0x03,0xE0,0x3C,0x03,0xC0,0x3E,
0x07,0xC0,0x3E,0x07,0xC0,0x1F,0x0F,0x80,0x1F,0x0F,0x80,0x1F,0xFF,0x80,0x0F,0xFF,
...
// ------------------  ASCII字模的数据表 ------------------------ //
 //码表从0x20~0x7e                                                //
 //字库: 字模Ⅲ软件 单色点阵液晶字模，横向取模，字节正序     0--9
 //字体：Impact  字形：常规  字号：小初
 //-------------------------------------------------------------- //
const unsigned char nAscii24x40Dot[] =              // ASCII
{
//0
	0x00,0xFE,0x00,0x07,0xFF,0x80,0x0F,0xFF,0xE0,0x1F,0xFF,0xF0,0x3F,0xFF,0xF0,0x3F,
	0xFF,0xF8,0x3F,0xC7,0xF8,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,
	...
	0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,
	0x7F,0xC7,0xFC,0x3F,0xC7,0xF8,0x3F,0xFF,0xF8,0x1F,0xFF,0xF8,0x1F,0xFF,0xF0,0x0F,
	0xFF,0xE0,0x07,0xFF,0xC0,0x00,0xFF,0x00,

//1
	0x00,0x00,0x00,0x00,0x0F,0x00,0x00,0x1F,0x00,0x00,0x7F,0x00,0x00,0xFF,0x00,0x03,
	0xFF,0x00,0x0F,0xFF,0x00,0x1F,0xFF,0x00,0x1F,0xFF,0x00,0x1F,0xFF,0x00,0x1F,0xFF,
...
//2
	0x00,0xFE,0x00,0x03,0xFF,0x80,0x07,0xFF,0xC0,0x0F,0xFF,0xE0,0x1F,0xFF,0xF0,0x1F,
	0xFF,0xF0,0x3F,0xCF,0xF0,0x3F,0x8F,0xF8,0x3F,0x8F,0xF8,0x3F,0x8F,0xF8,0x3F,0x8F,
	0xF8,0x3F,0x8F,0xF8,0x3F,0x8F,0xF8,0x3F,0x9F,0xF8,0x00,0x1F,0xF0,0x00,0x1F,0xF0,
	0x00,0x3F,0xF0,0x00,0x3F,0xF0,0x00,0x7F,0xE0,0x00,0x7F,0xE0,0x00,0xFF,0xC0,0x00,
	0xFF,0xC0,0x00,0xFF,0x80,0x01,0xFF,0x80,0x01,0xFF,0x80,0x03,0xFF,0x00,0x03,0xFF,
	0x00,0x07,0xFE,0x00,0x07,0xFE,0x00,0x0F,0xFC,0x00,0x0F,0xFC,0x00,0x1F,0xF8,0x00,
	0x1F,0xF8,0x00,0x3F,0xFF,0xF0,0x3F,0xFF,0xF0,0x3F,0xFF,0xF0,0x3F,0xFF,0xF0,0x3F,
	0xFF,0xF0,0x3F,0xFF,0xF0,0x00,0x00,0x00,

//3
	0x01,0xFF,0x00,0x07,0xFF,0xC0,0x0F,0xFF,0xF0,0x1F,0xFF,0xF0,0x1F,0xFF,0xF8,0x3F,
	0xFF,0xF8,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,
	0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x00,0x07,0xFC,0x00,0x0F,0xF8,0x00,0xFF,0xF8,
	0x00,0xFF,0xF0,0x00,0xFF,0xC0,0x00,0xFF,0xF0,0x00,0xFF,0xF8,0x00,0xFF,0xF8,0x00,
	0x0F,0xFC,0x00,0x0F,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,
	0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,0x3F,0xC7,0xFC,
	0x3F,0xC7,0xFC,0x1F,0xC7,0xF8,0x1F,0xFF,0xF8,0x1F,0xFF,0xF8,0x0F,0xFF,0xF0,0x07,
	0xFF,0xE0,0x03,0xFF,0xC0,0x00,0xFF,0x00,

//4
	0x00,0x00,0x00,0x00,0x7F,0xF8,0x00,0x7F,0xF8,0x00,0xFF,0xF8,0x00,0xFF,0xF8,0x00,
	0xFF,0xF8,0x01,0xFF,0xF8,0x01,0xFF,0xF8,0x01,0xFF,0xF8,0x03,0xFF,0xF8,0x03,0xFF,
	0xF8,0x03,0xFF,0xF8,0x07,0xEF,0xF8,0x07,0xEF,0xF8,0x07,0xEF,0xF8,0x0F,0xCF,0xF8,
	0x0F,0xCF,0xF8,0x0F,0xCF,0xF8,0x1F,0xCF,0xF8,0x1F,0x8F,0xF8,0x1F,0x8F,0xF8,0x3F,
	0x8F,0xF8,0x3F,0x0F,0xF8,0x3F,0x0F,0xF8,0x7F,0x0F,0xF8,0x7F,0x0F,0xF8,0x7F,0xFF,
	...
	0x0F,0xF8,0x00,0x0F,0xF8,0x00,0x00,0x00,

//5
	0x00,0x00,0x00,0x7F,0xFF,0xFC,0x7F,0xFF,0xFC,0x7F,0xFF,0xFC,0x7F,0xFF,0xFC,0x7F,
	0xFF,0xFC,0x7F,0xFF,0xFC,0x7F,0xC0,0x00,0x7F,0xC0,0x00,0x7F,0xC0,0x00,0x7F,0xC0,
	0x00,0x7F,0xC7,0xC0,0x7F,0xDF,0xF0,0x7F,0xFF,0xF0,0x7F,0xFF,0xF8,0x7F,0xFF,0xF8,
	0x7F,0xFF,0xFC,0x7F,0xCF,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x00,0x07,0xFC,0x00,
	0x07,0xFC,0x00,0x07,0xFC,0x00,0x07,0xFC,0x00,0x07,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,
	0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,
	0x7F,0xC7,0xFC,0x3F,0xE7,0xFC,0x3F,0xFF,0xF8,0x3F,0xFF,0xF8,0x1F,0xFF,0xF0,0x0F,
	0xFF,0xE0,0x07,0xFF,0xC0,0x00,0xFF,0x00,

//6
	0x00,0xFF,0x00,0x07,0xFF,0xC0,0x0F,0xFF,0xE0,0x1F,0xFF,0xF0,0x3F,0xFF,0xF8,0x3F,
	0xFF,0xF8,0x3F,0xC7,0xF8,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,
	0xFC,0x7F,0xC0,0x00,0x7F,0xC0,0x00,0x7F,0xCF,0xC0,0x7F,0xDF,0xE0,0x7F,0xFF,0xF0,
	0x7F,0xFF,0xF8,0x7F,0xFF,0xF8,0x7F,0xFF,0xFC,0x7F,0xCF,0xFC,0x7F,0xC7,0xFC,0x7F,
	0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,
	0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,0x7F,0xC7,0xFC,
	0x7F,0xC7,0xFC,0x3F,0xEF,0xFC,0x3F,0xFF,0xF8,0x3F,0xFF,0xF8,0x1F,0xFF,0xF0,0x0F,
	0xFF,0xE0,0x07,0xFF,0xC0,0x00,0xFF,0x00,

//7
	0x00,0x00,0x00,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,0xFF,0xFC,0x3F,
	0xFF,0xFC,0x3F,0xFF,0xFC,0x00,0x07,0xFC,0x00,0x07,0xFC,0x00,0x07,0xFC,0x00,0x07,
	0xF8,0x00,0x07,0xF8,0x00,0x0F,0xF8,0x00,0x0F,0xF8,0x00,0x0F,0xF8,0x00,0x0F,0xF8,
	0x00,0x0F,0xF0,0x00,0x1F,0xF0,0x00,0x1F,0xF0,0x00,0x1F,0xF0,0x00,0x1F,0xF0,0x00,
	0x1F,0xE0,0x00,0x3F,0xE0,0x00,0x3F,0xE0,0x00,0x3F,0xE0,0x00,0x3F,0xE0,0x00,0x3F,
	0xC0,0x00,0x7F,0xC0,0x00,0x7F,0xC0,0x00,0x7F,0xC0,0x00,0x7F,0xC0,0x00,0x7F,0x80,
	0x00,0xFF,0x80,0x00,0xFF,0x80,0x00,0xFF,0x80,0x00,0xFF,0x80,0x00,0xFF,0x00,0x01,
	0xFF,0x00,0x01,0xFF,0x00,0x00,0x00,0x00,

//8
	0x00,0xFF,0x80,0x03,0xFF,0xE0,0x07,0xFF,0xF8,0x0F,0xFF,0xF8,0x1F,0xFF,0xFC,0x1F,
	0xFF,0xFC,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,
	0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x1F,0xE3,0xFC,0x1F,0xFF,0xFC,
	0x0F,0xFF,0xF8,0x07,0xFF,0xE0,0x0F,0xFF,0xF8,0x1F,0xFF,0xFC,0x1F,0xFF,0xFC,0x1F,
	0xE7,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,
	0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,
	0x3F,0xE3,0xFE,0x3F,0xF3,0xFE,0x1F,0xFF,0xFC,0x1F,0xFF,0xFC,0x0F,0xFF,0xF8,0x07,
	0xFF,0xF0,0x03,0xFF,0xE0,0x00,0xFF,0x80,

//9
	0x00,0xFF,0x00,0x03,0xFF,0xE0,0x07,0xFF,0xF0,0x0F,0xFF,0xF8,0x1F,0xFF,0xFC,0x1F,
	0xFF,0xFC,0x3F,0xF3,0xFC,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,
	0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,
	0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xF3,0xFE,0x3F,0xFF,0xFE,0x1F,
	0xFF,0xFE,0x1F,0xFF,0xFE,0x0F,0xFF,0xFE,0x07,0xFB,0xFE,0x03,0xF3,0xFE,0x00,0x03,
	0xFE,0x00,0x03,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,0x3F,0xE3,0xFE,
	0x3F,0xE3,0xFE,0x1F,0xF3,0xFC,0x1F,0xFF,0xFC,0x1F,0xFF,0xFC,0x0F,0xFF,0xF8,0x07,
	0xFF,0xF0,0x03,0xFF,0xE0,0x00,0x7F,0x00,
...
// ------------------  ASCII字模的数据表 ------------------------ //
 //码表从0x20~0x7e                                                //
 //字库: 字模Ⅲ软件 单色点阵液晶字模，横向取模，字节正序     0--9
 //字体：Impact  字形：常规  字号：初号
 //-------------------------------------------------------------- //
const unsigned char nAscii28x48Dot[] =              // ASCII
{
//0
	0x00,0x00,0x00,0x00,0x00,0x3F,0xC0,0x00,0x01,0xFF,0xF8,0x00,0x07,0xFF,0xFE,0x00,
	0x0F,0xFF,0xFF,0x00,0x1F,0xFF,0xFF,0x80,0x1F,0xFF,0xFF,0x80,0x3F,0xF9,0xFF,0xC0,
	0x3F,0xF0,0xFF,0xC0,0x3F,0xF0,0xFF,0xC0,0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,
	...
	0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,
	0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,
	0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,0x7F,0xF0,0xFF,0xE0,0x3F,0xF0,0xFF,0xC0,
	0x3F,0xF9,0xFF,0xC0,0x1F,0xFF,0xFF,0x80,0x1F,0xFF,0xFF,0x80,0x0F,0xFF,0xFF,0x00,
	0x07,0xFF,0xFE,0x00,0x01,0xFF,0xF8,0x00,0x00,0x3F,0xE0,0x00,0x00,0x00,0x00,0x00,
...
// ------------------  ASCII字模的数据表 ------------------------ //
 //码表从0x20~0x7e                                                //
 //字库: 字模Ⅲ软件 单色点阵液晶字模，横向取模，字节正序     0--9
 //字体：Impact  字形：常规  字号：48
 //-------------------------------------------------------------- //
const unsigned char nAscii32x56Dot[] =              // ASCII
{
//0
	0x00,0x00,0x00,0x00,0x00,0x0F,0xF8,0x00,0x00,0x7F,0xFF,0x00,0x01,0xFF,0xFF,0x80,
	0x03,0xFF,0xFF,0xE0,0x07,0xFF,0xFF,0xF0,0x0F,0xFF,0xFF,0xF8,0x0F,0xFF,0xFF,0xF8,
	0x1F,0xFF,0x3F,0xFC,0x1F,0xFE,0x3F,0xFC,0x1F,0xFE,0x3F,0xFC,0x1F,0xFE,0x3F,0xFE,
	...
	0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,
	0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,0x3F,0xFE,
	0x1F,0xFE,0x3F,0xFC,0x1F,0xFE,0x3F,0xFC,0x1F,0xFE,0x7F,0xFC,0x0F,0xFF,0xFF,0xF8,
	0x0F,0xFF,0xFF,0xF8,0x07,0xFF,0xFF,0xF0,0x03,0xFF,0xFF,0xE0,0x01,0xFF,0xFF,0xC0,
	0x00,0x7F,0xFF,0x00,0x00,0x0F,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
// ------------------  ASCII字模的数据表 ------------------------ //
 ...
 //字体：Impact  字形：常规  字号：小初
 //-------------------------------------------------------------- //
const unsigned char nAscii48x80Dot[] =              // ASCII
{
//0
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xF8,0x00,0x00,0x00,0x03,0xFF,0xFF,
	0x00,0x00,0x00,0x0F,0xFF,0xFF,0xE0,0x00,0x00,0x3F,0xFF,0xFF,0xF0,0x00,0x00,0x7F,
	0xFF,0xFF,0xFC,0x00,0x01,0xFF,0xFF,0xFF,0xFE,0x00,0x01,0xFF,0xFF,0xFF,0xFF,0x00,
	0x03,0xFF,0xFF,0xFF,0xFF,0x80,0x07,0xFF,0xFF,0xFF,0xFF,0xC0,0x07,0xFF,0xFF,0xFF,
	0xFF,0xC0,0x0F,0xFF,0xFF,0xFF,0xFF,0xE0,0x0F,0xFF,0xFC,0x7F,0xFF,0xE0,0x1F,0xFF,
	0xFC,0x3F,0xFF,0xF0,0x1F,0xFF,0xF8,0x3F,0xFF,0xF0,0x1F,0xFF,0xF8,0x3F,0xFF,0xF0,
	0x1F,0xFF,0xF8,0x3F,0xFF,0xF0,0x1F,0xFF,0xF8,0x3F,0xFF,0xF8,0x3F,0xFF,0xF8,0x3F,
	...
	,
...
/* (10 X 20 , 宋体, 加粗 )*/
// -------------------------------------------------------------- //
const unsigned char nAscii10x20Dot[] =              // ASCII
{
	...
	0x06,0x00,0x00,0x00,0x00,0x00,0x0E,0x00,0x0E,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"!",1*/
	
	
	0x00,0x00,0x1F,0x80,0x1F,0x80,0x3F,0x00,0x36,0x00,0x6C,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	...
	0x31,0x80,0xFF,0xC0,0x31,0x80,0x31,0x80,0x73,0x80,0x63,0x00,
	0x63,0x00,0xFF,0xC0,0x63,0x00,0x63,0x00,0x63,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"#",3*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x00,0x1F,0x80,0x36,0xC0,
	0x36,0xC0,0x37,0xC0,0x1E,0x00,0x0E,0x00,0x07,0x00,0x07,0x80,
	0x06,0xC0,0x3E,0xC0,0x36,0xC0,0x36,0xC0,0x1F,0x80,0x06,0x00,
	0x06,0x00,0x00,0x00,/*"$",4*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x71,0x80,0xDB,0x00,
	0xDB,0x00,0xDE,0x00,0xDE,0x00,0xDC,0x00,0x7F,0x80,0x1E,0xC0,
	0x1E,0xC0,0x1E,0xC0,0x36,0xC0,0x36,0xC0,0x63,0x80,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"%",5*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x38,0x00,0x6C,0x00,
	0x6C,0x00,0x6C,0x00,0x7F,0x80,0x73,0x00,0x73,0x00,0xF6,0x00,
	0xDE,0x00,0xDE,0x00,0xCC,0x00,0x6E,0xC0,0x3B,0x80,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"&",6*/
	
	
	0x00,0x00,0x70,0x00,0x70,0x00,0x30,0x00,0x60,0x00,0xC0,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"'",7*/
	
	
	0x00,0x00,0x00,0xC0,0x01,0x80,0x03,0x00,0x06,0x00,0x06,0x00,
	0x06,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x03,0x00,0x01,0x80,
	0x00,0xC0,0x00,0x00,/*"(",8*/
	
	
	0x00,0x00,0xC0,0x00,0x60,0x00,0x30,0x00,0x18,0x00,0x18,0x00,
	0x18,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x30,0x00,0x60,0x00,
	0xC0,0x00,0x00,0x00,/*")",9*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x00,
	0x06,0x00,0x76,0xC0,0x7F,0xC0,0x0F,0x00,0x0F,0x00,0x7F,0xC0,
	0x76,0xC0,0x06,0x00,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	...
	0x00,0x00,0x00,0x40,0x00,0xC0,0x00,0xC0,0x01,0x80,0x01,0x80,
	...
	0x31,0x80,0x60,0xC0,0x60,0xC0,0x60,0xC0,0x60,0xC0,0x60,0xC0,
	0x60,0xC0,0x60,0xC0,0x31,0x80,0x31,0x80,0x1F,0x00,0x00,0x00,
	...
	0x60,0xC0,0x60,0xC0,0x60,0xC0,0x01,0x80,0x03,0x00,0x06,0x00,
	0x0C,0x00,0x18,0x00,0x30,0xC0,0x60,0xC0,0x7F,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"2",18*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3E,0x00,0x63,0x00,
	0x61,0x80,0x61,0x80,0x03,0x00,0x0F,0x00,0x01,0x80,0x00,0xC0,
	0x00,0xC0,0x60,0xC0,0x60,0xC0,0x61,0x80,0x3F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"3",19*/


	0x00,0x00,0x00,0x00,0x00,0x00,0x03,0x00,0x03,0x00,0x07,0x00,
	0x0F,0x00,0x1B,0x00,0x1B,0x00,0x33,0x00,0x63,0x00,0x63,0x00,
	0x7F,0xC0,0x03,0x00,0x03,0x00,0x03,0x00,0x0F,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"4",20*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xC0,0x30,0x00,
	0x30,0x00,0x30,0x00,0x30,0x00,0x3F,0x00,0x39,0x80,0x00,0xC0,
	0x00,0xC0,0x60,0xC0,0x60,0xC0,0x61,0x80,0x3F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"5",21*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0F,0x80,0x18,0xC0,
	0x30,0xC0,0x30,0x00,0x60,0x00,0x7F,0x00,0x71,0x80,0x60,0xC0,
	0x60,0xC0,0x60,0xC0,0x30,0xC0,0x31,0x80,0x1F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"6",22*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7F,0xC0,0x61,0x80,
	0x63,0x00,0x03,0x00,0x06,0x00,0x0C,0x00,0x0C,0x00,0x18,0x00,
	0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"7",23*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0x00,0x31,0x80,
	0x60,0xC0,0x60,0xC0,0x60,0xC0,0x31,0x80,0x1F,0x00,0x31,0x80,
	0x60,0xC0,0x60,0xC0,0x60,0xC0,0x31,0x80,0x1F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"8",24*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0x00,0x31,0x80,
	0x61,0x80,0x60,0xC0,0x60,0xC0,0x60,0xC0,0x31,0xC0,0x1F,0xC0,
	0x00,0xC0,0x01,0x80,0x61,0x80,0x63,0x00,0x3E,0x00,0x00,0x00,
	...
	0x70,0xC0,0x70,0xC0,0x00,0xC0,0x01,0x80,0x03,0x00,0x06,0x00,
	0x06,0x00,0x06,0x00,0x00,0x00,0x0E,0x00,0x0E,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"?",31*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0x00,0x33,0x80,
	0x6F,0xC0,0xDF,0xC0,0xDB,0xC0,0xF3,0xC0,0xF6,0xC0,0xF6,0xC0,
	0xF7,0x80,0xDF,0x80,0x60,0xC0,0x31,0x80,0x1F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"@",32*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x00,0x0C,0x00,
	0x1E,0x00,0x1E,0x00,0x1E,0x00,0x1E,0x00,0x33,0x00,0x33,0x00,
	0x3F,0x00,0x33,0x00,0x61,0x80,0x61,0x80,0xF3,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"A",33*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFE,0x00,0x63,0x00,
	0x63,0x00,0x63,0x00,0x66,0x00,0x7E,0x00,0x63,0x00,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x63,0x00,0xFE,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"B",34*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0xC0,0x31,0xC0,
	0x60,0xC0,0x60,0xC0,0xC0,0x00,0xC0,0x00,0xC0,0x00,0xC0,0x00,
	0xC0,0x00,0xC0,0xC0,0x60,0xC0,0x71,0x80,0x1F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"C",35*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFE,0x00,0x63,0x80,
	0x61,0x80,0x60,0xC0,0x60,0xC0,0x60,0xC0,0x60,0xC0,0x60,0xC0,
	0x60,0xC0,0x60,0xC0,0x61,0x80,0x63,0x00,0xFE,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"D",36*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x80,0x61,0x80,
	0x60,0xC0,0x63,0x00,0x63,0x00,0x7F,0x00,0x63,0x00,0x63,0x00,
	0x60,0x00,0x60,0x00,0x60,0xC0,0x61,0x80,0xFF,0x80,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"E",37*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x80,0x61,0x80,
	0x60,0xC0,0x63,0x00,0x63,0x00,0x7F,0x00,0x63,0x00,0x63,0x00,
	0x60,0x00,0x60,0x00,0x60,0x00,0x60,0x00,0xF0,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"F",38*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0F,0xC0,0x19,0xC0,
	0x30,0xC0,0x60,0xC0,0x60,0x00,0x60,0x00,0x60,0x00,0x61,0xC0,
	0x60,0xC0,0x60,0xC0,0x30,0xC0,0x38,0xC0,0x0F,0x80,0x00,0x00,
	...
	0x61,0x80,0x61,0x80,0x61,0x80,0x61,0x80,0xF3,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"H",40*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7F,0x80,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x7F,0x80,0x00,0x00,
	...
	0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0xC6,0x00,0xCC,0x00,
	0x78,0x00,0x00,0x00,/*"J",42*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF7,0xC0,0x63,0x00,
	0x66,0x00,0x66,0x00,0x6C,0x00,0x7C,0x00,0x7C,0x00,0x66,0x00,
	0x66,0x00,0x63,0x00,0x63,0x00,0x61,0x80,0xF3,0xC0,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF3,0xC0,0x73,0x80,
	0x73,0x80,0x73,0x80,0x7F,0x80,0x7F,0x80,0x7F,0x80,0x7F,0x80,
	0x7F,0x80,0x6D,0x80,0x6D,0x80,0x6D,0x80,0xFF,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"M",45*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF3,0xC0,0x71,0x80,
	0x79,0x80,0x79,0x80,0x79,0x80,0x6D,0x80,0x6D,0x80,0x67,0x80,
	0x67,0x80,0x63,0x80,0x63,0x80,0x63,0x80,0xF1,0x80,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"N",46*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1E,0x00,0x73,0x80,
	0x61,0x80,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,
	0xC0,0xC0,0xC0,0xC0,0x61,0x80,0x73,0x80,0x1E,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"O",47*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0x61,0x80,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1E,0x00,0x73,0x80,
	0x61,0x80,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,
	0xC0,0xC0,0xDC,0xC0,0x77,0x80,0x77,0x80,0x1F,0x00,0x03,0xC0,
	0x03,0x80,0x00,0x00,/*"Q",49*/


	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFE,0x00,0x63,0x00,
	0x61,0x80,0x61,0x80,0x63,0x00,0x7E,0x00,0x6C,0x00,0x66,0x00,
	0x66,0x00,0x63,0x00,0x63,0x00,0x61,0x80,0xF1,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"R",50*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0xC0,0x31,0xC0,
	0x60,0xC0,0x60,0x00,0x60,0x00,0x38,0x00,0x0F,0x00,0x01,0x80,
	0x00,0xC0,0x60,0xC0,0x60,0xC0,0x71,0x80,0x7F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"S",51*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7F,0x80,0xCC,0xC0,
	0xCC,0xC0,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x1E,0x00,0x00,0x00,
	...
	0x1E,0x00,0x1E,0x00,0x1E,0x00,0x0C,0x00,0x0C,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"V",54*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xC0,0x6D,0x80,
	0x6D,0x80,0x6D,0x80,0x6D,0x80,0x7F,0x80,0x7F,0x80,0x7F,0x80,
	0x7F,0x00,0x33,0x00,0x33,0x00,0x33,0x00,0x33,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"W",55*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7B,0xC0,0x31,0x80,
	0x33,0x00,0x1B,0x00,0x1E,0x00,0x0E,0x00,0x0C,0x00,0x0E,0x00,
	0x1E,0x00,0x1B,0x00,0x1B,0x00,0x31,0x80,0x7B,0xC0,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xC0,0x31,0x80,
	0x61,0x80,0x03,0x00,0x03,0x00,0x06,0x00,0x0C,0x00,0x0C,0x00,
	0x18,0x00,0x18,0x00,0x30,0xC0,0x31,0x80,0x7F,0x80,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"Z",58*/
	
	
	0x00,0x00,0x0F,0xC0,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0F,0xC0,
	0x00,0x00,0x00,0x00,/*"[",59*/


	0x00,0x00,0x00,0x00,0x60,0x00,0x30,0x00,0x30,0x00,0x18,0x00,
	0x18,0x00,0x18,0x00,0x0C,0x00,0x0C,0x00,0x06,0x00,0x06,0x00,
	0x06,0x00,0x03,0x00,0x03,0x00,0x01,0x80,0x01,0x80,0x01,0x80,
	0x00,0xC0,0x00,0x00,/*"\",60*/
	...
	0x00,0x00,0x1E,0x00,0x1E,0x00,0x33,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0xFF,0xC0,/*"_",63*/
	
	
	0x00,0x00,0x1C,0x00,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x3F,0x00,0x61,0x80,0x61,0x80,0x0F,0x80,
	0x39,0x80,0x61,0x80,0x61,0x80,0x63,0xC0,0x3F,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"a",65*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xE0,0x00,0x60,0x00,
	0x60,0x00,0x60,0x00,0x7E,0x00,0x73,0x00,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x73,0x00,0x7E,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"b",66*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x1F,0x00,0x31,0x80,0x61,0x80,0x60,0x00,
	...
	0x01,0x80,0x01,0x80,0x1F,0x80,0x33,0x80,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x33,0x80,0x1F,0xC0,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0xC0,0x0C,0x40,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x1F,0xC0,0x31,0x80,0x31,0x80,0x31,0x80,
	0x31,0x80,0x1F,0x00,0x30,0x00,0x3F,0x00,0x31,0xC0,0x60,0xC0,
	0x60,0xC0,0x3F,0x80,/*"g",71*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xE0,0x00,0x60,0x00,
	0x60,0x00,0x60,0x00,0x7F,0x00,0x71,0x80,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x61,0x80,0xF3,0xC0,0x00,0x00,
	...
	0x66,0x00,0x7C,0x00,/*"j",74*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xE0,0x00,0x60,0x00,
	0x60,0x00,0x60,0x00,0x67,0x80,0x66,0x00,0x6C,0x00,0x78,0x00,
	0x7C,0x00,0x66,0x00,0x63,0x00,0x61,0x80,0xF3,0xC0,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0xFF,0x00,0x6D,0x80,0x6D,0x80,0x6D,0x80,
	0x6D,0x80,0x6D,0x80,0x6D,0x80,0x6D,0x80,0xFF,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"m",77*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0xFF,0x00,0x71,0x80,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x61,0x80,0xF3,0xC0,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0xFE,0x00,0x73,0x00,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x73,0x00,0x7E,0x00,0x60,0x00,
	0x60,0x00,0xF0,0x00,/*"p",80*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x1F,0x80,0x33,0x80,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x33,0x80,0x1F,0x80,0x01,0x80,
	0x01,0x80,0x03,0xC0,/*"q",81*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x7B,0xC0,0x1E,0xC0,0x1C,0x00,0x18,0x00,
	0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x7E,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"r",82*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x3F,0x80,0x63,0x80,0x61,0x80,0x70,0x00,
	0x1E,0x00,0x03,0x80,0x61,0x80,0x71,0x80,0x7F,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"s",83*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x3F,0x80,0x0C,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0D,0x80,0x07,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"t",84*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0xE3,0x80,0x61,0x80,0x61,0x80,0x61,0x80,
	0x61,0x80,0x61,0x80,0x61,0x80,0x63,0x80,0x3F,0xC0,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"u",85*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0xF3,0xC0,0x61,0x80,0x33,0x00,0x33,0x00,
	0x33,0x00,0x1E,0x00,0x1E,0x00,0x0C,0x00,0x0C,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"v",86*/
	
	
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0xFF,0xC0,0x6D,0x80,0x6D,0x80,0x6D,0x80,
	0x7F,0x80,0x7F,0x80,0x33,0x00,0x33,0x00,0x33,0x00,0x00,0x00,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x7F,0xC0,0x31,0x80,0x19,0x80,0x1B,0x00,
	0x1B,0x00,0x0F,0x00,0x0E,0x00,0x06,0x00,0x0C,0x00,0x0C,0x00,
	0x0C,0x00,0x38,0x00,/*"y",89*/


	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x7F,0x80,0x63,0x00,0x66,0x00,0x06,0x00,
	0x0C,0x00,0x18,0x00,0x31,0x80,0x61,0x80,0x7F,0x80,0x00,0x00,
	0x00,0x00,0x00,0x00,/*"z",90*/
	
	
	0x00,0x00,0x01,0xC0,0x03,0x00,0x03,0x00,0x03,0x00,0x03,0x00,
	0x03,0x00,0x03,0x00,0x07,0x00,0x0C,0x00,0x07,0x00,0x03,0x00,
	0x03,0x00,0x03,0x00,0x03,0x00,0x03,0x00,0x03,0x00,0x03,0x00,
	0x01,0xC0,0x00,0x00,/*"",91*/
	
	
	0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,
	0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,
	0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,
	0x06,0x00,0x06,0x00,/*"|",92*/
	
	
	0x00,0x00,0x70,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,
	0x18,0x00,0x18,0x00,0x1C,0x00,0x06,0x00,0x1C,0x00,0x18,0x00,
	0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,
	0x70,0x00,0x00,0x00,/*"",93*/
	
	
	0x3C,0x00,0x76,0x40,0x66,0xC0,0x03,0xC0,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
